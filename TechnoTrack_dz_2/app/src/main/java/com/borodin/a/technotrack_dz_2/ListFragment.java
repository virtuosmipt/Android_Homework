...
public class ListFragment extends Fragment {
    public static String LOG_TAG = "_log";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RecyclerView mRecyclerView = (RecyclerView) root.findViewById(R.id.my_recycler_view);
        ...
        MyAdapter wa = new MyAdapter(getActivity(), R.layout.list_item, ImageData.instance().getImages());
    ...
    private class MyAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int position) {
            ...
            holder._tvw = (TextView)convertView.findViewById(R.id.element_text);
            holder._iv = (ImageView)convertView.findViewById(R.id.element_picture);
...
//                    android.app.FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
               //  MyPagerFragment myPagerFragment= MyPagerFragment.newInstance(holder._pos);
//                    fragmentTransaction.add(R.id.main_fragment,myPagerFragment);
                    // (SecondActivity)getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.main_fragment,myPagerFragment);


                }

            });
            Log.d(LOG_TAG,word.getImage());
